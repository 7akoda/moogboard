...
function Layout({ children }) {
  ...
  return /* @__PURE__ */ jsxs("html", { lang: "en", className: scrollClass, children: [
...
const Hold = ({
  ...
  const playTone = () => {
    ...
    if (SynthProp == Tone.Synth) {
      ...
      setTimeout(() => synth.dispose(), fadeOutDuration * 1e3);
    }
...
const Row = ({ children, viewBox }) => {
  const isMobile = /Mobi|Android|iPhone|iPad|iPod/i.test(navigator.userAgent);
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx(
    "svg",
    {
      className: isMobile ? " max-w-[80dvw] max-h-[4.5dvh]" : " w-[45dvw] max-h-[5dvh]",
      viewBox,
      children
    }
  ) });
...
const holdData18 = [
  {
    id: "18A",
    viewBox: "-2.67425 -11.8 242.5 24.57",
...
const Board = ({ climb }) => {
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57 ", children: holdData18.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData17.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData16.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData15.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData14.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData13.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData12.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData11.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData10.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData9.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData8.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData7.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData6.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData5.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData4.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData3.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData2.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
    ...
    /* @__PURE__ */ jsx(Row, { viewBox: "0 0 242.5 24.57", children: holdData1.map((hold) => /* @__PURE__ */ jsx(
      Hold,
      {
        active: climb == null ? void 0 : climb.hold_ids.includes(hold.id),
        viewBox: hold.viewBox,
...
const Line = ({ bpm, animate }) => {
  return /* @__PURE__ */ jsx("div", { className: " flex flex-col justify-start items-center  z-0 ", children: /* @__PURE__ */ jsx(
    "svg",
    {
      viewBox: "0 0 242.5 1.2",
      className: animate && bpm == 10 ? "lineMoving10" : animate && bpm == 7 ? "lineMoving7" : animate && bpm == 4 ? "lineMoving4" : "absolute h-auto invisible ",
      xmlns: "http://www.w3.org/2000/svg",
  ...
  return /* @__PURE__ */ jsxs("div", { className: "flex flex-col justify-start items-center", children: [
    ...
    /* @__PURE__ */ jsxs("div", { className: "flex flex-row ", children: [
      /* @__PURE__ */ jsx(
        ...
        {
          disabled: animate,
          className: bpm == 10 && animate ? "buttonSMSelectedPlaying" : bpm != 10 && animate ? "buttonSMPlaying" : bpm == 10 && !animate ? "buttonSMSelected" : "buttonSM",
          onClick: () => setBpm(10),
          children: "slow"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          disabled: animate,
          className: bpm == 7 && animate ? "buttonSMSelectedPlaying" : bpm != 7 && animate ? "buttonSMPlaying" : bpm == 7 && !animate ? "buttonSMSelected" : "buttonSM",
          onClick: () => setBpm(7),
          children: "medium"
        }
      ),
      /* @__PURE__ */ jsx(
        ...
        {
          disabled: animate,
          className: bpm == 4 && animate ? "buttonSMSelectedPlaying" : bpm != 4 && animate ? "buttonSMPlaying" : bpm == 4 && !animate ? "buttonSMSelected" : "buttonSM",
          onClick: () => setBpm(4),
          children: "fast"
        }
      )
...
const supabaseUrl = "https://mdzmnwuwjeixnhuwpdbf.supabase.co";
const supabaseKey = "eyJhbGciOiJIUzI1NiIsInR5cCI6IkpXVCJ9.eyJpc3MiOiJzdXBhYmFzZSIsInJlZiI6Im1kem1ud3V3amVpeG5odXdwZGJmIiwicm9sZSI6ImFub24iLCJpYXQiOjE3Mzc5MTY3MDEsImV4cCI6MjA1MzQ5MjcwMX0.d8qg-ZvwOR-5WACQoDvzXOU3pOa9o439rcefNBFu7ZQ";
...
const Search = ({ climb, setClimb }) => {
  ...
  const handleRowClick = async (climb2) => {
    const data = await fetchClimbById(climb2.id);
    setClimb(data);
  ...
  return /* @__PURE__ */ jsxs("div", { className: "h-full", children: [
    ...
    /* @__PURE__ */ jsxs("table", { className: "flex flex-col pt-6 h-[85%]  ", children: [
      /* @__PURE__ */ jsx("thead", { children: /* @__PURE__ */ jsxs("tr", { className: "flex flex-row justify-between px-2", children: [
        /* @__PURE__ */ jsx("th", { children: "Name" }),
        /* @__PURE__ */ jsx("th", { children: "Grade" })
      ] }) }),
      /* @__PURE__ */ jsx("tbody", { className: "scrollBar", children: (climbs == null ? void 0 : climbs.filter(
        (c) => c.name.toLowerCase().includes(searchTerm.toLowerCase())
      ).map((c) => /* @__PURE__ */ jsxs(
        "tr",
        {
          className: `flex flex-row justify-between text-lg cursor-pointer p-2 rounded-md ${(climb == null ? void 0 : climb.id) === c.id ? "bg-gray-200" : "hover:bg-gray-100"}`,
          role: "row",
          tabIndex: 0,
          ...
          children: [
            ...
            /* @__PURE__ */ jsx("td", { children: c.grade })
          ]
        },
        c.id
      ))) ?? /* @__PURE__ */ jsx("tr", { children: /* @__PURE__ */ jsx("td", { colSpan: 2, children: "No climbs available" }) }) })
    ] })
  ] });
};
const SideBar = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "right-2 top-2 bottom-2 fixed z-10 outline-none max-w-[25dvw] flex ", children: /* @__PURE__ */ jsx("div", { className: "bg-zinc-50 p-5 h-full w-full flex flex-col rounded-[16px]", children: /* @__PURE__ */ jsxs("div", { className: "max-w-[300px] overflow-hidden z-10", children: [
    /* @__PURE__ */ jsx("p", { className: "  justify-self-start font-medium mb-12 text-gray-900", children: "MoogBoard by 7akoda" }),
    /* @__PURE__ */ jsx("div", { className: "flex flex-row justify-self-center ", children: /* @__PURE__ */ jsx(
      BpmControl,
      {
        handleClick,
        animate,
    ...
    /* @__PURE__ */ jsx(Search, { setClimb, climb }),
    /* @__PURE__ */ jsx("div", { className: "mt-[81.3dvh] p-4 bg-gray-100 border-t border-gray-200 rounded-[16px] ", children: /* @__PURE__ */ jsxs("div", { className: " pt-100 flex flex-row justify-end align-bottom gap-6 max-w-[100px] mx-auto", children: [
      /* @__PURE__ */ jsxs(
        "a",
        {
...
const PopUpPlay = ({
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "flex flex-col justify-self-center justify-items-center ", children: /* @__PURE__ */ jsxs(Drawer.Root, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsx(Drawer.Trigger, { className: "fixed bottom-[25px] z-30 left-[1/2] -translate-x-1/2 rounded-md transition-all", children: /* @__PURE__ */ jsxs(Fragment, { children: [
      /* @__PURE__ */ jsxs(
        "svg",
        {
    ...
    /* @__PURE__ */ jsx(Drawer.Portal, { children: /* @__PURE__ */ jsxs(Drawer.Content, { className: "z-40 bg-gray-100 flex flex-col rounded-t-[10px] mt-24 h-fit fixed bottom-0 left-0 right-0 outline-none", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-4 bg-white rounded-t-[10px] flex-1", children: [
        /* @__PURE__ */ jsx("div", { className: "mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-gray-300 " }),
        /* @__PURE__ */ jsxs("div", { className: "max-w-[750px] mx-auto", children: [
          /* @__PURE__ */ jsx(Drawer.Title, { className: "font-medium mb-10 pt-2 text-gray-900", children: "MoogBoard by 7akoda" }),
          /* @__PURE__ */ jsx(
            BpmControl,
            {
              handleClick,
      ...
      /* @__PURE__ */ jsx("div", { className: "p-4 bg-gray-100 border-t border-gray-200 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-6 justify-end max-w-md mx-auto", children: [
        /* @__PURE__ */ jsxs(
          "a",
          {
            className: "text-xs text-gray-600 flex items-center gap-0.25",
...
const PopUpSearch = ({ climb, setClimb }) => {
  const [open, setOpen] = React.useState(false);
  useEffect(() => {
    setOpen(false);
  }, [climb]);
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "flex flex-col justify-self-center justify-items-center", children: /* @__PURE__ */ jsxs(Drawer.Root, { open, onOpenChange: setOpen, children: [
    /* @__PURE__ */ jsx(Drawer.Trigger, { className: " z-30 fixed bottom-2 left-[20%] -translate-x-1/2 overflow-hidden rounded-md transition-all", children: /* @__PURE__ */ jsx(
      "svg",
      {
    ...
    /* @__PURE__ */ jsx(Drawer.Portal, { children: /* @__PURE__ */ jsxs(Drawer.Content, { className: "z-40 bg-gray-100 flex flex-col rounded-t-[10px] mt-24 h-[80%] lg:h-[320px] fixed bottom-0 left-0 right-0 outline-none", children: [
      /* @__PURE__ */ jsxs("div", { className: "p-4 bg-white rounded-t-[10px] flex-1 overflow-y-auto", children: [
        /* @__PURE__ */ jsx("div", { className: "mx-auto w-12 h-1.5 flex-shrink-0 rounded-full bg-gray-300 " }),
        /* @__PURE__ */ jsxs("div", { className: "max-w-[750px] mx-auto", children: [
          /* @__PURE__ */ jsx(Drawer.Title, { className: "font-medium mb-12 text-gray-900", children: "MoogBoard by 7akoda" }),
          /* @__PURE__ */ jsx(Search, { setClimb, climb })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "p-4 bg-gray-100 border-t border-gray-200 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-6 justify-end max-w-md mx-auto", children: [
...
const PopUpInfo = () => {
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsx("div", { className: "flex flex-col justify-self-center justify-items-center ", children: /* @__PURE__ */ jsxs(Drawer.Root, { children: [
    /* @__PURE__ */ jsx(Drawer.Trigger, { className: " z-30 fixed bottom-2 right-[20%] translate-x-1/2 overflow-hidden rounded-md transition-all", children: /* @__PURE__ */ jsx(
      "svg",
      {
        className: "w-[10dvw] h-[45px]",
        viewBox: "0 0 24 24",
      ...
      /* @__PURE__ */ jsxs("div", { className: "p-4 bg-white rounded-t-[10px] flex-1", children: [
        ...
        /* @__PURE__ */ jsxs("div", { className: "max-w-[750px] mx-auto", children: [
          ...
          /* @__PURE__ */ jsxs("p", { className: "text-gray-600 mb-2", children: [
            "A React app where MoonBoard 2019 climbing holds become musical triggers—colliding with a moving line to generate dynamic compositions using 18 chords and 4 instruments. Discover the harmony",
            " ",
            /* @__PURE__ */ jsx(
              "a",
              {
          ...
          /* @__PURE__ */ jsx("p", { className: "text-gray-600 text-xs", children: "Although there are many benchmarked climbs in the database feel free to create your own!." })
        ] })
      ] }),
      /* @__PURE__ */ jsx("div", { className: "p-4 bg-gray-100 border-t border-gray-200 mt-auto", children: /* @__PURE__ */ jsxs("div", { className: "flex gap-6 justify-end max-w-md mx-auto", children: [
        /* @__PURE__ */ jsxs(
...
const BottomBar = ({
  ...
  return /* @__PURE__ */ jsxs(Fragment, { children: [
    ...
    /* @__PURE__ */ jsx(PopUpSearch, { climb, setClimb }),
    /* @__PURE__ */ jsx(PopUpInfo, {})
  ] });
};
const meta = () => {
  return [
...
function Index() {
  ...
  return /* @__PURE__ */ jsx(Fragment, { children: /* @__PURE__ */ jsxs("div", { className: "flex flex-col items-center justify-center ", children: [
    /* @__PURE__ */ jsx(Mooglogo, {}),
    /* @__PURE__ */ jsxs("div", { className: isMobile ? "slide-in-mobile" : "slide-in", children: [
      /* @__PURE__ */ jsx(Board, { climb }),
      /* @__PURE__ */ jsx(Line, { bpm, animate }),
